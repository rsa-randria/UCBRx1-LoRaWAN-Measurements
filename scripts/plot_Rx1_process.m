...
base_dir = '../data/raw/power_profiling/receive_windows/rx1';
...
files = { 
    'ppk-rx1-standard-NACK.csv',...
    'ppk-rx1-standard-ACK.csv',...
    'ppk-rx1-ucb-ACK.csv'
};
...
for i = 1:length(files)
    ...
    end_idx = min(length(Current_mA), start_idx + 10000 - 1);
...
plot_path_fig = fullfile(output_folder, 'rx1_compare.fig');
plot_path_eps = fullfile(output_folder, 'rx1_compare.eps');
